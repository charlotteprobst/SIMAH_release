...
data_orig  <- "/Users/carolinkilian/Desktop/SIMAH_workplace/nesarc/1_Original data/NESARC I and II/"
data_orig3  <- "/Users/carolinkilian/Desktop/SIMAH_workplace/nesarc/1_Original data/NESARC III/"
data_new   <- "/Users/carolinkilian/Desktop/SIMAH_workplace/nesarc/2_Processed data/"
...
nesarc2 <- nesarc2_orig %>%
  ...
  saveRDS(nesarc2, paste0(data_new, "nesarc2_raw.rds"))
...
nesarc3 <- nesarc3_orig %>%
  ...
  select( idnum, AUDWEIGHT, VARUNIT, VARSTRAT, NAGE, NSEX, nethrace, NMARITAL, NEDUC, 
