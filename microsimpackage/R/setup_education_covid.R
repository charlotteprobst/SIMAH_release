...
#' @examples
#' setup_education
setup_education_covid <- function(basepop,y){
  basepop$agecat <- ifelse(basepop$microsim.init.age==18, "18",
                           ifelse(basepop$microsim.init.age==19, "19",
                                  ifelse(basepop$microsim.init.age==20, "20",
                                                ifelse(basepop$microsim.init.age>=21 & basepop$microsim.init.age<=25, "21-25","26+"))))
  ...
  basepop$year <- ifelse(y<=2019, "1999-2019", 
                         ifelse(y==2020|y==2021|y==2022, "2019-2022", NA))
