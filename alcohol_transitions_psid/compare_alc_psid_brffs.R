...
PSID <- PSID %>% drop_na(AlcCAT, race_eth)
...
ggsave("SIMAH_workplace/PSID/Results/Alcohol trends/compare_gpd_brfss.png",dpi=300, width=33, height=19, units="cm")
...
ggplot(data=summary_2, aes(x=year, y=meangpd, colour=type)) + geom_line() + ylim(0,NA) + theme_bw() +
  ...
  theme(legend.title=element_blank(),
        strip.background = element_rect(fill="white"))
ggsave("SIMAH_workplace/PSID/Results/Alcohol trends/compare_gpd_brfss_race_sex.png",dpi=300, width=33, height=19, units="cm")
...
ggsave("SIMAH_workplace/PSID/Results/Alcohol trends/compare_prevalence_drinkers_brfss_race_sex.png",dpi=300, width=33, height=19, units="cm")
...
ggplot(data=summary_cat_psid_brfss, aes(x=year, y=percent, colour=type)) + geom_line() + ylim(0,NA) + 
  theme_bw() +
  theme(legend.title=element_blank(),
        strip.background = element_rect(fill="white")) +
...
ggsave("SIMAH_workplace/PSID/Results/Alcohol trends/compare_categories_brfss.png",dpi=300, width=33, height=19, units="cm")
