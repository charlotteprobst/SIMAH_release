...
source("SIMAH_code/microsim/0_generate_baseline_population/0_IPF_functions.R")
...
# which BRFSS years do you want to use to generate the baseline population? 
...
write.csv(processed_data, "SIMAH_workplace/microsim/1_generating_population/brfss_with_weights.csv", row.names=F)
