...
ggplot(subset(implausibility, AlcCAT=="Low risk" & microsim.init.race=="SPA"), aes(x=year, y=propsimulation, colour=as.factor(samplenum))) + geom_line() +
  ...
  ggtitle("Uninformed - Low risk- Hispanic")
ggsave("SIMAH_workplace/HispanicLRuninformedprior.png", dpi=300, width=33, height=19, units='cm')
