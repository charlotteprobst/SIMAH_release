                                                ...
                                                ifelse(data$age==22, 5,
                                                       ifelse(data$age==23, 6,
                                                              ifelse(data$age==24, 7,
                                                                     ifelse(data$age==25, 8,
                                                                            ifelse(data$age==26, 9,
                                                                                   ifelse(data$age>=27, 10, NA
                                                                                   ))))))))))
                      ...
                      ifelse(data$tosplit==2, (origyear-1):origyear,
                             ifelse(data$tosplit==3, (origyear-2):origyear,
                                    ifelse(data$tosplit==4, (origyear-3):origyear,
                                      ...
                                      ifelse(data$tosplit==8, (origyear-7):origyear,
                                             ifelse(data$tosplit==9, (origyear-8):origyear,
                                                    ifelse(data$tosplit==10, (origyear-9):origyear, NA)))))))
                                      )))
