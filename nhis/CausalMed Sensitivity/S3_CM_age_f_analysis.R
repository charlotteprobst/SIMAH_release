...
CMed_f_25_59 <- aalen(Surv(bl_age, end_age, allcause_death) ~ const(A.edu) * const(edu_M1.alc) + 
      ...
      summary(CMed_f_model_25_59)   #Estimates and SE
      getTE_NotRobust(CMed_f_model_25_59, c(1,3,5,7,9,29,33,37,41))  # Simulated estimate and SE for total effect and mediated proportions for other effects
      getIE_NotRobust(CMed_f_model_25_59, c(3,5,7,9,29,33,37,41))    # Estimate and simulated SE for indirect combined effect
      getTE_IE_NotRobust(CMed_f_model_25_59, c(1,3,5,7,9,29,33,37,41), c(3,5,7,9,29,33,37,41)) # Mediated proportion and simulated 95% CI for mediated proportion of indirect combined effect
...
CMed_f_60_69 <- aalen(Surv(bl_age, end_age, allcause_death) ~ const(A.edu) * const(edu_M1.alc) + 
      ...
      # Get final results. NOTE: THE NUMBERS BELOW MAY HAVE TO BE CHANGED IF A DIFFERENT MODEL IS USED
      summary(CMed_f_model_60_69)   #Estimates and SE
      getTE_NotRobust(CMed_f_model_60_69, c(1,3,5,7,9,29,33,37,41))  # Simulated estimate and SE for total effect and mediated proportions for other effects
      getIE_NotRobust(CMed_f_model_60_69, c(3,5,7,9,29,33,37,41))    # Estimate and simulated SE for indirect combined effect
      getTE_IE_NotRobust(CMed_f_model_60_69, c(1,3,5,7,9,29,33,37,41), c(3,5,7,9,29,33,37,41)) # Mediated proportion and simulated 95% CI for mediated proportion of indirect combined effect
...
CMed_f_70_85 <- aalen(Surv(bl_age, end_age, allcause_death) ~ const(A.edu) * const(edu_M1.alc) + 
      ...
      # Get final results. NOTE: THE NUMBERS BELOW MAY HAVE TO BE CHANGED IF A DIFFERENT MODEL IS USED
      summary(CMed_f_model_70_85)   #Estimates and SE
      getTE_NotRobust(CMed_f_model_70_85, c(1,3,5,7,9,29,33,37,41))  # Simulated estimate and SE for total effect and mediated proportions for other effects
      getIE_NotRobust(CMed_f_model_70_85, c(3,5,7,9,29,33,37,41))    # Estimate and simulated SE for indirect combined effect
      getTE_IE_NotRobust(CMed_f_model_70_85, c(1,3,5,7,9,29,33,37,41), c(3,5,7,9,29,33,37,41)) # Mediated proportion and simulated 95% CI for mediated proportion of indirect combined effect
