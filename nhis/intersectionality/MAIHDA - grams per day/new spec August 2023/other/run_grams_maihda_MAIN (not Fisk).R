...
saveRDS(coefs_table, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/grams model coefficients and variance_MAIN.rds")
write.csv(coefs_table, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/grams model coefficients and variance_MAIN.csv")
...
##### Save estimates
saveRDS(mdata_results_2, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/estimated_grams_MAIN.RDS")
write.csv(mdata_results_2, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/estimated_grams_MAIN.csv")
...
ggsave("C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/plots/new spec August 2023/grams/observed vs estimated grams ranks_MAIN.png", 
       dpi=300, width=33, height=19, units="cm")
...
coefs_table <- rbind(coefs_null, coefs_full)
saveRDS(coefs_table, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/grams model coefficients and variance_drinkers_spec_3.rds")
write.csv(coefs_table, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/grams model coefficients and variance_drinkers_spec_3.csv")
...
##### Save estimates
saveRDS(mdata_results_2, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/estimated_grams_drinkers_spec_3.RDS")
write.csv(mdata_results_2, "C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/results tables/new spec August 2023/grams/estimated_grams_drinkers_spec_3.csv")

##### Explore face validity of back-transformed data
temp <- mdata_results_2 %>% dplyr::select(intersectional_names, count, mean_observed_grams, back_transformed_estimate)
ggplot(temp, aes(x=mean_observed_grams, y=back_transformed_estimate)) + geom_point() +
  ggtitle("Comparisson of observed and estimated daily grams, 180 intersectional groups")
ggsave("C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/plots/new spec August 2023/grams/observed vs estimated grams_drinkers_spec_3.png", 
       dpi=300, width=33, height=19, units="cm")
# Interpretation: Positive correlation but generally estimates are lower than observed.  
...
ggplot(temp, aes(x=rank_observed_grams, y=rank_estimated_grams)) + geom_point() +
  ggtitle("Comparisson of observed vs estimated drinking 'rank', 180 intersectional groups")
ggsave("C:/Users/cmp21seb/Documents/SIMAH/SIMAH_workplace/nhis/intersectionality/plots/new spec August 2023/grams/observed vs estimated grams ranks_drinkers_spec_3.png", 
       dpi=300, width=33, height=19, units="cm")
# Interpretation: Positive correlation but some groups are estimated to be in a higher ranking drinking category than the observed grams may suggest.
# The discrepancies between observed and estimated are expected to be related to by shrinkage.