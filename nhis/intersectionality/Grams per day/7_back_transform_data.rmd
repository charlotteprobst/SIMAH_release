...
log_transformed_data_post_MAIHDA <- readRDS("U:/SIMAH/SIMAH_workplace/nhis/intersectionality/cleaned_data/MAIHDA_results_MCMC_log.RDS")
```
...
saveRDS(temp, "U:\\SIMAH\\SIMAH_workplace\\nhis\\intersectionality\\cleaned_data\\comparisson of observed and estimated grams.RDS")
```

# Save back-transformed data
```{r}
saveRDS(back_transformed_data_log, "U:/SIMAH/SIMAH_workplace/nhis/intersectionality/cleaned_data/back_transformed_data_log.RDS")

write_xlsx(x = back_transformed_data_log, path = "U:/SIMAH/SIMAH_workplace/nhis/intersectionality/cleaned_data/back_Transformed_data_log.xlsx", col_names = TRUE)
```
