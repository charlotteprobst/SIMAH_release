...
recode_education <- function(data){
  ...
  # 5 categories
   education_5_cats = dplyr::case_when(
      ...
      EDUCREC2 == 10|EDUCREC2 == 20|EDUREC == 30| EDUCREC2 == 31|EDUCREC2 == 32 ~ 1, # no high school (<= grade 8)
  ...
  education_3_cats = dplyr::case_when(
    ...
    EDUCREC2 == 10|EDUCREC2 == 20|EDUREC == 30|EDUCREC2 == 31|EDUCREC2 == 32|EDUCREC2 == 41|EDUCREC2 == 42 ~ 1, # High school or less
