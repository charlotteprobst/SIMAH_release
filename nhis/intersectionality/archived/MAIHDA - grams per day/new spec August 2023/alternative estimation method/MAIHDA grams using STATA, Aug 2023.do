...
insheet using "C:\Users\cmp21seb\Documents\SIMAH\SIMAH_workplace\nhis\intersectionality\cleaned_data\new Spec August 2023\grams\grams_data_pre_maihda_main.csv", comma clear // Read in the data in csv format
...
Run time (seconds)   =       7.51
Number of iterations =          3
Log likelihood       = -1201907.6
Deviance             =  2403815.3
------------------------------------------------------------------------------
capped_dai~g |      Coef.   Std. Err.      z    P>|z|     [95% Conf. Interval]
-------------+----------------------------------------------------------------
  _2001_year |   .0769646   .0208396    3.69    0.000     .0361197    .1178095
  _2002_year |   .0472083   .0212014    2.23    0.026     .0056543    .0887622
  _2003_year |   .0142525   .0210668    0.68    0.499    -.0270376    .0555427
  _2004_year |   .0023068   .0209682    0.11    0.912    -.0387902    .0434037
  _2005_year |     .06137   .0209148    2.93    0.003     .0203778    .1023622
  _2006_year |   .0523107   .0224759    2.33    0.020     .0082589    .0963626
  _2007_year |   .0844002   .0227143    3.72    0.000      .039881    .1289195
  _2008_year |   .2103163   .0230705    9.12    0.000      .165099    .2555336
  _2009_year |   .2672203   .0215605   12.39    0.000     .2249625    .3094781
  _2010_year |   .2324411   .0216831   10.72    0.000      .189943    .2749392
  _2011_year |   .2525446   .0206072   12.26    0.000     .2121552    .2929339
  _2012_year |   .2347478   .0204113   11.50    0.000     .1947423    .2747533
  _2013_year |   .2759937    .020391   13.54    0.000     .2360282    .3159593
  _2014_year |   .3079427   .0201129   15.31    0.000     .2685221    .3473633
  _2015_year |   .2789689    .020506   13.60    0.000     .2387779    .3191599
  _2016_year |   .4011359   .0206305   19.44    0.000     .3607009     .441571
  _2017_year |   .4458574   .0217706   20.48    0.000     .4031879    .4885269
  _2018_year |   .4118593   .0220109   18.71    0.000     .3687188    .4549998
        cons |  -1.313137   .1067156  -12.31    0.000    -1.522296   -1.103978
------------------------------------------------------------------------------
...
Level 2: intersections       |
                   var(cons) |   1.177419    .163668      .8566356    1.498203
-----------------------------+------------------------------------------------
Level 1: nhispid             |
                   var(cons) |   6.144816   .0120937      6.121113     6.16852
------------------------------------------------------------------------------

*/

* Interpretation:  β0 = -1.313
*				   between-intersection variance = 1.18
*				   between individual variance = 6.14
...
-------------+---------------------------------------------------------------
           . |    516,439          .   -1201908      21    2403857    2404092
-----------------------------------------------------------------------------
...
// ~16% of variation at the intersectional level
