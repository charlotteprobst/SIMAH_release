...
data nhis_mort_clean; set nhis_mort_clean;
	...
	new_weight = sa_wgt_new / 18;  /*divided by 18 because 18 survey years pooled from NHIS (1997-2014)*/
	new_psu = PSU;
...
Format 	alcohol5 alc5_use. 		alcohol6 alc6_use. 			heavy_drinker heavy_drink. 	
		...
		DODYEAR DODYFMT.;
run;
/* Note: Final file is called nhis_mort_clean and is stored in the location 'combined' (defined at the start of the file) */
