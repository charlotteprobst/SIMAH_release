...
if(k.run == "detail") {
  if(k.pop_type=="ACS"){
    dDecomp <- read.csv("SIMAH_workplace/life_expectancy/2_out_data/2020_decomp/Results_contrib_2019_2020_detail_ACS.csv")
  ...
  if(k.pop_type=="ACS"){
    dDecomp <- read.csv("SIMAH_workplace/life_expectancy/2_out_data/2020_decomp/Results_contrib_2019_2020_ses_ACS.csv")
  }else if(k.pop_type=="ACS_pred"){
...
write.csv(dgathered, paste0("SIMAH_workplace/life_expectancy/2_out_data/2020_decomp/decomp_results_2020_", 
...
ggsave(plot = dcomp_plot, 
       filename =  
         paste0("SIMAH_workplace/life_expectancy/3_graphs/2020_decomp/decomp_plot_2020_categories",
                k.pop_type, "_",
                k.run, ".jpeg"), 
       dpi=600, width=30, height=15, units="cm", device = "jpeg")
...
write.csv(dcat, paste0("SIMAH_workplace/life_expectancy/2_out_data/2020_decomp/decomp_results_2020_", 
