...
source("~/Desktop/CAMH/Fall 2023/SIMAH II/2b_decomp_functions.R")
...
dMort <- read.csv("allethn_sumCOD_1821_LE_decomp.csv")
table(dMort$year)
#dMort0 <- read.csv("allethn_sumCOD_0020_LE_decomp.csv")

#read in population data
ACS <- read.csv("ACS_popcounts_2000_2021_updated.csv")
table(ACS$year)
...
k.run <- "ses" # "ses" or "detail" or "total"
k.weights <- FALSE 
...
write.csv(dle_results, 
          paste0("~/Desktop/CAMH/Fall 2023/SIMAH II/Output/", 
