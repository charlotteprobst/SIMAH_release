...
#setwd("C:/Users/celin/Dropbox/Celine/SIMAH/Mortality and LE")
setwd("C:/Users/marie/Dropbox/NIH2020/")

#dResults_contrib <- read.csv("dResults_contrib_2000_2018CPS.csv")
dResults_contrib <- read.csv("LE/3_out data/dResults_contrib_2000_2018CPS.csv")
