...
modelt1_baseline <- readRDS("SIMAH_workplace/education_transitions/final_models/modelt1_baseline.RDS")
modelt1_income <- readRDS("SIMAH_workplace/education_transitions/final_models/modelt1_income.RDS")
modelt1_income_int <- readRDS("SIMAH_workplace/education_transitions/final_models/modelt1_income_int.RDS")

modelt2_baseline <- readRDS("SIMAH_workplace/education_transitions/final_models/modelt2_baseline.RDS")
modelt2_income <- readRDS("SIMAH_workplace/education_transitions/final_models/modelt2_income.RDS")
modelt2_income_int <- readRDS("SIMAH_workplace/education_transitions/final_models/modelt2_income_int.RDS")

datat1baseline <- extract_coefficients(modelt1_baseline, "baseline", "1999-2009", datat1)
datat1income <- extract_coefficients(modelt1_income, "income", "1999-2009", datat1)
datat1incomeint <- extract_coefficients(modelt1_income_int, "incomeint", "1999-2009", datat1)

datat2baseline <- extract_coefficients(modelt2_baseline, "baseline", "2009-2019", datat2)
datat2income <- extract_coefficients(modelt2_income, "income", "2009-2019", datat2)
datat2incomeint <- extract_coefficients(modelt2_income_int, "incomeint", "2009-2019", datat2)

coefs <- rbind(datat1baseline, datat1income,datat1incomeint,
               datat2baseline, datat2income, datat2incomeint) %>% 
...
write.csv(table, "SIMAH_workplace/education_transitions/final_models/income_model_table.csv", row.names=F)
