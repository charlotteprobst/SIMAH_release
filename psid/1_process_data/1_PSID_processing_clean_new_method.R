...
race <- process_race(main_data) # loosing 4 people here, check case_when statements again
...
n_distinct(inconsistent_data_main$uniqueID) # 6,132
...
n_allocated_final_race <- n_distinct(temp$uniqueID)
