...
quietly infix                ///
  ...
  byte    asian     108-109  ///
  byte    citizen   110-110  ///
  int     hispan    111-113  ///
  int     educ      114-116  ///
  byte    educ99    117-118  ///
  double  ftotval   119-128  ///
  double  inctot    129-137  ///
  byte    poverty   138-139  ///
  long    cutoff    140-145  ///
  using `"cps_00001.dat"'
...
label var inttype  `"Interview type"'
...
label define inttype_lbl 00 `"Non-interview"'
label define inttype_lbl 01 `"In person"', add
label define inttype_lbl 02 `"Telephone"', add
label define inttype_lbl 03 `"Information Collection Request filled"', add
label define inttype_lbl 04 `"Interview, type unspecified"', add
label values inttype inttype_lbl
