...
// NEW: LABEL FOR STATE// 
label def state 1 "Alabama" 2 "Alaska" 4 "Arizona" 5 "Arkansas" 6 "California" 8 "Colorado" 9 "Connecticut" 10 "Delaware" ///
...
label val fipsstr state
 
save "${dir}/mortality/3_out data/mort_0021_complete_STATE.dta", replace
