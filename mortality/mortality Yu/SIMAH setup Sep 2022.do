...
//Final notes: latest modification drops those types belonging to LE decomposition, but not belong to SIMAH model
//such as covid, panc, stroke, etc
//A setup file for "LE decompoisition" is generated separately
...
save "c:\temp\1_allethn_mortbycause_0020_SIMAH.dta", replace	


use "c:\temp\1_allethn_mortbycause_0020_SIMAH.dta", clear
...
tabstat lvdc hlvdc dm ihd istr hyphd aud uij mvacc ij rest one, ///
...
save "c:\temp\2_allethn_sumCOD_0020_SIMAH.dta", replace
...
use "c:\temp\2_allethn_sumCOD_0020_SIMAH.dta", clear
...
save "c:\temp\allethn_sumCOD_0020_SIAMH.dta", replace
...
use "c:\temp\allethn_sumCOD_0020_SIAMH.dta", clear
outsheet using "allethn_sumCOD_0020_SIMAH.csv" , comma replace
